...
def _call_claude_market_analysis(data: dict) -> dict:
    ...
    def _build_prompt(d: dict) -> str:
        ...
        return (
            ...
            "🌐 קונפליקטים גיאופוליטיים מתמשכים — חובה לקחת בחשבון:\n"
            "• מלחמת רוסיה-אוקראינה — מתמשכת, משפיעה על מחירי אנרגיה, חיטה, ושרשראות אספקה\n"
            "• מתיחות ישראל/ארה\"ב מול איראן — כולל תמיכה איראנית בחיזבאללה וחמאס, איום גרעיני\n"
            "• מתיחות סין-ארה\"ב — מכסים הדדיים, מתיחות בים סין הדרומי, תחרות טכנולוגית\n\n"
            f"📅 אירועי מאקרו קרובים (7 ימים):\n{_events_str}\n\n"
            f"📰 כותרות אקטואליות (גיאופוליטיות וכלכליות):\n{_headlines_str}\n\n"
            "כללי ניתוח מוסדי — חובה לעמוד בכולם:\n"
            "1. גיאופוליטיקה: תמיד הזכר את הקונפליקטים המתמשכים ואת השפעתם על השוק\n"
            ...
            "5. אם יש כותרות ספציפיות — צטט אותן; אם לא — הסתמך על הקונפליקטים המתמשכים ועל נתוני השוק\n\n"
